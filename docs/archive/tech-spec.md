...
> - [database_schema.md](database_schema.md) — Current Prisma schema (50 models, multi-tenant)
...
> **Note:** This section shows the original simplified schema from Phase 1. For the current complete schema (50 models with multi-tenancy, RBAC, and generic naming), see [database_schema.md](database_schema.md).
